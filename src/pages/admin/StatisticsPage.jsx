...
const StatisticsPage = () => {
    ...
    const handleExportExcel = async () => {
        try {
            const response = await apiClient.get('/system-admin/check-in-statistics/export-excel', {
                responseType: 'blob'
            });
            const url = window.URL.createObjectURL(new Blob([response.data]));
            const link = document.createElement('a');
            link.href = url;
            link.setAttribute('download', 'checkin_history.xlsx');
            ...
            <div className="statistics-header">
                ...
                <div className="statistics-actions">
                    ...
                    <button
                        ...
                        disabled={loading || checkInData.length === 0}
                    >
                        Xuất Excel
                    </button>
                </div>
